 ...
 * @since 0.11
 */
class StreamTimeline extends \yii\base\Widget
{
    ...
    public function run()
    {
        return $this->render('streamtimeline', ['streamUrl' => $this->getStreamUrl(), 'showFilters' => $this->showFilters, 'filters' => $this->filters]);
    }
